 ...
 *
 * This module is used to generate and validate DHIS2 uids. A valid DHIS2 uid is a 11 character
 * string which starts with a letter from the ISO basic Latin alphabet.
 */
